...
class Logger(irclib.SimpleIRCClient):
	...
	def __init__(self, server, port, channel, nick, password, username, ircname, localaddress, localport, ssl, ipv6,
				postgresql_server, postgresql_port, postgresql_database, postgresql_user, postgresql_password):
		...
		self.postgresql_user = postgresql_user
	...
	def on_ping(self, connection, event):
		self.last_ping = 0
		try:
			db = pierc_db.Pierc_DB( self.postgresql_server,
