...
class Pierc_DB:
	...
	def create_table(self):
		self.cursor.execute("CREATE TABLE IF NOT EXISTS main (id integer PRIMARY KEY, channel VARCHAR(16), name VARCHAR(16), time TIMESTAMP, message TEXT, type VARCHAR(10), hidden CHAR(1));")
